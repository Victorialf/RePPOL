...
<!--ATTENTION : les chemins de result document ne fonctionnent qu'en local il faut donc adapter-->
	...
	<xsl:variable name="out" select="'../03_website/output/'"/>
...
<!-- Variables pour links -->
	...
	<xsl:variable name="avenir" select="'https://www.gouvernement.fr/le-programme-d-investissements-d-avenir'"/>
	<xsl:variable name="fr2030" select="'https://www.gouvernement.fr/france-2030'"/>
	<xsl:variable name="iuf" select="'https://www.iufrance.fr/'"/>
	<!--	template pour HEAD-->
	...
	<xsl:template name="header">
		...
		<header id="top">
			...
			<div class="links">
				<a href="files/reppol_ms128.xml" download="" style="grid-column:3; grid-row:2"><img src="img/logo_xml.png" alt="xml"/></a>
...
<!--<!-\-		Plus nécessaie après body{overflow:nope}-\->
	...
	<xsl:template name="footer">
		<section class="home footer">
			...
			<div class="footer_logo" style="filter: grayscale(100%); width:10%;">
				<a href="{$avenir}" target="blanck">
					<img src="img/logo_avenir.png"/>
				</a>
			</div>
			<div class="footer_logo" style="filter: grayscale(100%); width:10%;">
				<a href="{$fr2030}" target="blanck">
					<img src="img/logo_fr2030.jpg"/>
				</a>
			</div>
			<div class="footer_logo" style="filter: grayscale(100%); width:10%;">
				<a href="{$iuf}" target="blanck">
					<img src="img/logo_iuf.png"/>
				</a>
			</div>
		</section>
...
<!--			<hr/>-->
		<section class="home sponsor">
			...
			<xsl:for-each select="//tei:funder">
				...
				<p><a href="{$iuf}" target="blanck">Institut Universitaire de France</a></p>
				<p><a href="{$fr2030}" target="blanck">France 2030</a></p>
				<p><a href="{$avenir}" target="blanck">Investissement d'avenir</a></p>
		</section>
	</xsl:template>
<!--	DÉBUT page home-->
	<xsl:template match="tei:TEI">
		<xsl:result-document href="{concat($out,$home)}">
			<html>
...
<!--	FIN page HOME-->
<!--	DÉBUT page LEGALS-->
		<xsl:result-document href="{concat($out,$legals)}">
			<html>
				<xsl:call-template name="head">
						...
						<!--class="project_right" /version colonne/-->
							...
							<p>Le projet RePPOL est un projet scientifique et pédagogique collaboratif consacré à la transcription, l'édition critique et l'analyse du manuscrit <a href="https://parker.stanford.edu/parker/catalog/ps908cx9813" target="blanck">MS 128 conservé à la bibliothèque de Corpus Christi College, Cambridge</a>.<br />Pour en savoir plus, cliquez <a href="#moreabout">ICI</a>.</p>-->
								...
								<ul>
									...
									<li><a href="{$iuf}" target="blanck">Institut Universitaire de France</a></li>
									<li><a href="{$fr2030}" target="blanck">France 2030</a></li>
									<li><a href="{$avenir}" target="blanck">Investissement d'avenir</a></li>
								</ul>
							<!--<h3>Host</h3>
...
<!--	FIN page BIBLIO-->
<!--	DÉBUT page ABOUT-->
		<xsl:result-document href="{concat($out,$about)}">
			<html>
				<xsl:call-template name="head">
...
<!--	FIN page ABOUT-->
<!--	DÉBUT page PEDAGO-->
		<xsl:result-document href="{concat($out,$pedago)}">
				<html>
					<xsl:call-template name="head">
