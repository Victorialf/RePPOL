...
<!--				FORM & SEARCH-->
	...
	<xsl:template match="/">
		...
		<xsl:result-document href="{concat($out,$index_characters)}">
			<html>
		...
		<!--		PAGE INDEX PLACES-->
		<xsl:result-document href="{concat($out,$index_places)}">
			<html>
				<xsl:call-template name="head">
...
<!--									<h2>map :</h2>-->
		...
		<!--		PAGE INDEX DATES-->
		<xsl:result-document href="{concat($out,$index_dates)}">
			<html>
				<xsl:call-template name="head">
...
<!--		FIN page INDEX DATE-->
		...
		<xsl:result-document href="{concat($out,$transcriptions, '.html')}">
			<html>
				<xsl:call-template name="head">
...
<!--		PAGES DE TRANSCRIPTIONS INDIVIDUELLES-->
		<xsl:for-each select="//tei:text[@xml:id = 'reppol_trans']//tei:pb">
			...
			<xsl:result-document href="{concat($out,$transcriptions, @n, '.html')}">
				<html>
					<xsl:call-template name="head">
